...
TRAIN_JSONL="${TRAIN_JSONL:-/scrinvme/huilin/traffic_sign/defect/detection/data_det_3_damaged_traffic_signs/qwen_crop/train.jsonl}"
VAL_JSONL="${VAL_JSONL:-/scrinvme/huilin/traffic_sign/defect/detection/data_det_3_damaged_traffic_signs/qwen_crop/val.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-output/qwen3vl_crop_cls_lora}"
